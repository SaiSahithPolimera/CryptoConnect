      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
          ...
          <p className="text-left mt-5 text-white font-medium md:w-9/12 w-11/12 text-base">
            Explore the Crypto world. Buy and sell crypto easily with
            CryptoConnect
          </p>
          <button
            type="button"
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
            <div className={`rounded-tl-2xl ${commonStyles}`}>Reliabitlity</div>
          ...
          <div className="p-3 flex justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card .white-glassmorphism ">
            ...
            <div className="h-[1px] w-full bg-gray-400 my-2" />
              {false? (
                ...
                className="text-white w-full mt-2 border-[1px] p-2 rounded-full cursor-pointer border-[#3d4f7c]">
                    Send Now
                </button>
              )}
            </div>
